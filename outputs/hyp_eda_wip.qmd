...
The main point to note from this chart is that GP hypertension with a record of a blood pressure reading reached the highest percentage up to 88.7% of people aged 18+ were recorded over this period.
...
There is a clear pattern demonstrated here that as age-group increases so too does the likelihood for hypertension to be treated within limits.However, this relationship is not so nearly as strong as that observed between high risk – one high blood pressure (no recorded hypertension) and age group (see @sec-national-trends).
...
df |> 
  plot_timeseries(
    plot_title = "England high risk – one high blood pressure with no recorded hypertension (CVDP005HYP) - broad ethnic group",
    y_axis_title = "People with high risk – one high blood pressure no recorded hypertension \n(percent)"
  )
```
...
There is a clear relationship between deprivation quintile and high risk – one high blood pressure with no recorded hypertension. People living in areas of higher deprivation consistently achieve lower rates of recorded blood pressure reading compared with those living in areas of least deprivation.
...
df |> 
  plot_timeseries(
    plot_title = "England high risk – one high blood pressure with no recorded hypertension (CVDP005HYP) - SMI",
    y_axis_title = "People with high risk – one high blood pressure no recorded hypertension \n(percent)"
  )
```
...
df |> 
  plot_timeseries(
    plot_title = "England high risk – one high blood pressure with no recorded hypertension (CVDP005HYP) - LD",
    y_axis_title = "People with high risk – one high blood pressure no recorded hypertension\n(percent)"
  )
```
