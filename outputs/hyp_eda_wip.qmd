...
Use of the crude treatment rates appears to present fewer issues than it did when looking at hypertension prevalence. The age groups are much closer in their blood pressure reading record rates which means any differences in age profile between geographical areas are less likely to result in large effects on the overall treatment rate for the area.
