...
```{r}
#| fig-height: 8
#| fig-cap: Timeseries of the rate of people with high risk – one high blood pressure (no recorded hypertension) in England by ethnicity
...
The relationship between deprivation and igh risk – one high blood pressure with no recorded hypertension is more complex, for example the most deprived group does not consistently have the higher rate with Quitile 4 often being the highest. Similarly for Quntiles 5 and 2 for the lowest rates for this outcome.
